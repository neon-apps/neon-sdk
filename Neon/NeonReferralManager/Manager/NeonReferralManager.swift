...
public class NeonReferralManager {
                ...
                if document.get("Credit") != nil {
                    ...
                    userRef.setData([
                        ...
                        if let error = error {
                            ...
                            print("Document successfully written1!")
                            self.fetchUserCredit()
                        }
                    }
                }
    ...
    public static func configure(amount: Int,
                          lottieName: String,
                          freeText: String,
                          thirdLabelText: String,
                          descriptionLabelText: String,
                          remainingBackgroundColor: UIColor,
                          mainTextColor: UIColor,
                          mainColor: UIColor,
                          descriptionColor: UIColor,
                          backgroundColor: UIColor,
                          textFieldbackgroundcolor: UIColor,
                          textFieldBordorColor: UIColor,
                          buttonTextColor: UIColor,
                          sheetBackgroundColor: UIColor) {
        setDatabase()
        
        NeonReferralConstants.amount = amount
        NeonReferralConstants.lottieName = lottieName
        NeonReferralConstants.freeText = freeText
        NeonReferralConstants.thirdLabelText = thirdLabelText
        NeonReferralConstants.descriptionLabelText = descriptionLabelText
        NeonReferralConstants.remainingBackgroundColor = remainingBackgroundColor
        NeonReferralConstants.mainTextColor = mainTextColor
        NeonReferralConstants.mainColor = mainColor
        NeonReferralConstants.descriptionColor = descriptionColor
        NeonReferralConstants.backgroundColor = backgroundColor
        NeonReferralConstants.textFieldbackgroundcolor = textFieldbackgroundcolor
        NeonReferralConstants.textFieldBordorColor = textFieldBordorColor
        NeonReferralConstants.buttonTextColor = buttonTextColor
        NeonReferralConstants.sheetBackgroundColor = sheetBackgroundColor
       }
