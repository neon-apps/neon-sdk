...
class CodeViewVC: UIViewController {
    ...
    let remainingCredit = PaddedLabel()
    ...
    func setupUI(){
        ...
        remainingCredit.backgroundColor = NeonReferralConstants.remainingBackgroundColor
        remainingCredit.textAlignment = .center
        remainingCredit.textColor = NeonReferralConstants.mainTextColor
        remainingCredit.textInsets = UIEdgeInsets(top: 8, left: 8, bottom: 8, right: 8)
        ...
        let showLottie = LottieManager.createLottie(animation: .custom(name: NeonReferralConstants.lottieName))
        ...
        inviteFriendsLabel.textColor = NeonReferralConstants.mainTextColor
        ...
        let freeAny = UILabel()
        freeAny.text = NeonReferralConstants.freeText
        ...
        firstLabel.textColor = NeonReferralConstants.mainTextColor
        ...
        secondLabel.textColor = NeonReferralConstants.mainTextColor
        ...
        thirdLabel.text = NeonReferralConstants.thirdLabelText
        thirdLabel.font = Font.custom(size: 16, fontWeight: .Regular)
        thirdLabel.textColor = NeonReferralConstants.mainTextColor
        ...
        descriptionLabel.text = NeonReferralConstants.descriptionLabelText
        descriptionLabel.numberOfLines = 0
        descriptionLabel.font = Font.custom(size: 14, fontWeight: .Regular)
        descriptionLabel.textAlignment = .center
        descriptionLabel.textColor = NeonReferralConstants.descriptionColor
        ...
        let ReferanceCodeLabel = PaddedLabel()
        ...
        ReferanceCodeLabel.textColor = NeonReferralConstants.mainTextColor
        ReferanceCodeLabel.backgroundColor = NeonReferralConstants.textFieldbackgroundcolor
        ...
        ReferanceCodeLabel.layer.borderColor = NeonReferralConstants.textFieldBordorColor.cgColor
        ReferanceCodeLabel.textInsets = UIEdgeInsets(top: 0, left: 15, bottom: 0, right: 0)
        ...
        userCodeLabel.textColor = NeonReferralConstants.mainTextColor
    ...
    func gradientConfigure(){
        ...
        gradientTopColor = .customBlue.withAlphaComponent(0.2)
    ...
    func setupNotificationView() {
        notificationView.backgroundColor = NeonReferralConstants.descriptionColor
        ...
        notificationViewText.textColor = NeonReferralConstants.mainTextColor
