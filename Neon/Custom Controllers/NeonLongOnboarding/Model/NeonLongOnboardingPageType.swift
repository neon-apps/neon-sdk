...
public enum NeonLongOnboardingPageType{
    case singleSelection(question : String, subtitle: String?, options : [NeonLongOnboardingOption], whyDoWeAsk : String? = nil, shouldContinueWhenSelected : Bool = true)
    ...
    case beforeAfter(title : String, subtitle: String?, beforeItems : [String], afterItems : [String], beforeLabel : String = "Before", afterLabel : String = "After")
    ...
    case contract(emoji : String, title : String, items : [String], confirmLabel : String = "Long press to confirm")
    case letsGo(question : String, image : UIImage, hideNoButton : Bool = false)
    case statement(title : String, statement : String, image : UIImage, yesButtonTitle : String = "Yes", noButtonTitle : String = "No")
