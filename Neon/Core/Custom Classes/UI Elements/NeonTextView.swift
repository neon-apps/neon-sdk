...
public class NeonTextView: UITextView {
    ...
    private func commonInitializer() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(NeonTextView.handleTextViewTextDidChangeNotification(_:)), name: UITextView.textDidChangeNotification, object: self)
    }
    
    @objc internal func handleTextViewTextDidChangeNotification(_ notification: Notification) {
        
        guard let object = notification.object as? NeonTextView, object === self else {
