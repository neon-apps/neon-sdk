...
final class MaskLayerViewModel {
    ...
    var animationDuration = TimeInterval.NeonGradientProgressBar.progressAnimationDuration

    /// Animation timing function for an animated progress change.
    var timingFunction = CAMediaTimingFunction.NeonGradientProgressBar.progressAnimationFunction
