...
public class CustomAlertManager {
    ...
    public static func showAlert(viewController: UIViewController, title: String?, message: String?, icon: UIImage? = nil, iconTintColor: UIColor? = nil, iconSize: CGSize = CGSize(width: 50, height: 50), verticalPadding : CGFloat = 20, buttons: [CustomAlertButton]? = nil) {
