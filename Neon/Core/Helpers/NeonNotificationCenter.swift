...
public class NeonNotificationCenter{
    ...
    public static func observe(id : String, preserveActiveObservers : Bool = false, completion: @escaping (_ object : Any?) -> ()){
        if !preserveActiveObservers{
            removeObserver(id: id)
        }
    ...
    public static func observe(id : String, preserveActiveObservers : Bool = false, completion: @escaping () -> ()){
        if !preserveActiveObservers{
            removeObserver(id: id)
        }
